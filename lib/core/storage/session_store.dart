...
///
/// Mở app lần sau chỉ cần token còn hạn là vào thẳng (kiểm tra bằng
/// `GET /auth/me` — xem `core/network/session_check.dart`), không cần đăng nhập
/// lại. iOS giữ Keychain sau khi gỡ app nên cài lại mà token cũ vẫn còn hạn thì
/// app vẫn vào thẳng (chỉ tin token, không phân biệt cài mới/cài lại).
